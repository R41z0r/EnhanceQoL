...
frame.title:SetFont(addon.variables.defaultFont, addon.variables.defaultFontSize, "OUTLINE")
...
frame.editEditBox:SetFont(addon.variables.defaultFont, addon.variables.defaultFontSize, "OUTLINE")
...
frame.outputEditBox:SetFont(addon.variables.defaultFont, addon.variables.defaultFontSize, "OUTLINE")
...
local function UpdatePerformanceFrame()
    ...
    for _, log in ipairs(addon.Performance.Log) do
        ...
        line:SetFont(addon.variables.defaultFont, addon.variables.defaultFontSize, "OUTLINE")
        yOffset = yOffset + 20
    end
...
local function ShowPerformanceData()
    if not performanceFrame then
        ...
        performanceFrame.title:SetFont(addon.variables.defaultFont, addon.variables.defaultFontSize, "OUTLINE")
