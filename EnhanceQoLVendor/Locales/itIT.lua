...
L["vendorSwapAutoSellShift"] = "Vendere automaticamente solo quando Shift è premuto all'apertura"
L["vendorOnly12Items"] = "Limita il numero di oggetti venduti per transazione a 12, consentendo un riacquisto più semplice dal mercante."
...
L["vendorMinIlvl"] = "Segna gli oggetti con un ilvl inferiore al valore selezionato per la vendita automatica"
L["vendorAbsolutIlvl"] = "Usa il ilvl assoluto per vendere gli oggetti invece del ilvl minimo equipaggiato"

for _, key in ipairs(addon.Vendor.variables.tabKeyNames) do
	local value = addon.Vendor.variables.tabNames[key]
	L["labelItemQuality" .. value .. "line"] = "Questo ti consente di vendere automaticamente gli oggetti di qualità "
		.. ITEM_QUALITY_COLORS[key].hex
		.. _G["ITEM_QUALITY" .. key .. "_DESC"]
		.. "|r in base ai criteri di filtro quando sei da un mercante."
	L["vendor" .. value .. "Enable"] = "Abilita la vendita automatica per oggetti di qualità " .. ITEM_QUALITY_COLORS[key].hex .. _G["ITEM_QUALITY" .. key .. "_DESC"] .. "|r"
	L["labelExplained" .. value .. "line"] = "Ciò significa che vende automaticamente "
		.. ITEM_QUALITY_COLORS[key].hex
		.. _G["ITEM_QUALITY" .. key .. "_DESC"]
		.. "|r gli oggetti con un livello di oggetto di %s e inferiore %s"
end
