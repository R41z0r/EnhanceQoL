...
L["vendorSwapAutoSellShift"] = "Venda automática apenas quando Shift for pressionado ao abrir"
L["vendorOnly12Items"] = "Limita o número de itens vendidos por transação a 12, facilitando a recompra no comerciante."
...
L["vendorMinIlvl"] = "Marcar itens com um ilvl abaixo do valor selecionado para venda automática"
L["vendorAbsolutIlvl"] = "Use o ilvl absoluto para vender equipamentos em vez do ilvl mínimo equipado"
...
for _, key in ipairs(addon.Vendor.variables.tabKeyNames) do
	...
	L["labelExplained" .. value .. "line"] = "Isso significa que ele vende automaticamente "
		.. ITEM_QUALITY_COLORS[key].hex
		.. _G["ITEM_QUALITY" .. key .. "_DESC"]
		.. "|r itens com um nível de item de %s ou inferior %s"
end
