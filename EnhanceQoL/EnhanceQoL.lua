...
local addChatFrame = UI.addChatFrame
local addMinimapFrame = UI.addMinimapFrame
local addUnitFrame = UI.addUnitFrame
local addAuctionHouseFrame = UI.addAuctionHouseFrame
local addActionBarFrame = UI.addActionBarFrame
local addUIFrame = UI.addUIFrame
local initUnitFrame = UI.initUnitFrame
local initBagsFrame = UI.initBagsFrame
local initChatFrame = UI.initChatFrame
local initUI = UI.initUI
