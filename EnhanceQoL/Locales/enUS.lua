...
L["showBagFilterMenu"] = "Enable item filter on bags"
L["showBagFilterMenuDesc"] = "Only usable when combined bags is selected"
L["fadeBagQualityIcons"] = "Enable fading of profession quality icons on search and filter"
...
L["CVarOptions"] = {
	...
	["addonProfilerEnabled"] = { description = "Enable the Blizzard Addon Profiler (consumes much CPU)", trueValue = "1", falseValue = "0", register = true },
}
