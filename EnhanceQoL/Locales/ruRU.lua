...
L["showBagFilterMenuDesc"] = "Доступно только при включённом режиме «Объединённые сумки»"
L["fadeBagQualityIcons"] = "Включить затухание иконок качества профессий при поиске и фильтрации"
L["bagFilterOff"] = "Фильтр выключен"
L["bagFilterOn"] = "Фильтр включён"
