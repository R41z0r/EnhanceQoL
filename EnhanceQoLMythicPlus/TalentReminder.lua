...
local function showPopup(actTalent, requiredTalent)
    ...
    reloadFrame.title:SetFont(addon.variables.defaultFont, addon.variables.defaultFontSize, "OUTLINE")
    ...
    reloadFrame.curTalentHeadling:SetFont(addon.variables.defaultFont, addon.variables.defaultFontSize, "OUTLINE")
    ...
    reloadFrame.curTalent:SetFont(addon.variables.defaultFont, addon.variables.defaultFontSize, "OUTLINE")
    ...
    reloadFrame.reqTalentHeadling:SetFont(addon.variables.defaultFont, addon.variables.defaultFontSize, "OUTLINE")
    ...
    reloadFrame.reqTalent:SetFont(addon.variables.defaultFont, addon.variables.defaultFontSize, "OUTLINE")
