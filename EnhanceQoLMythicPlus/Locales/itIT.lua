...
L["groupFilter"] = "Filtro di gruppo"
L["mythicPlusEnableDungeonFilter"] = "Estende il filtro dei dungeon di gruppo di Blizzard con nuovi filtri"
L["mythicPlusEnableDungeonFilterClearReset"] = "Pulisci i filtri estesi al reset del filtro Blizzard"
L["filteredTextEntries"] = "Filtrati\n%d elementi"
