...
L["autoMarkTankExplanation"] = "Будет поставлена метка на "
	.. TANK
	.. ", если на нём ещё нет метки; она поменяется только в случае, если вы "
...
L["MissingTalentLoadout"] =
	"Некоторые наборы талантов, использованные в Напоминании о талантах,\nбыли удалены и больше не доступны:"
...
L["mythicPlusNoHealerMark"] = "Убирать мою метку, если я нахожусь в роли лекаря"
